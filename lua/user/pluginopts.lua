  ...
  lisp = {
    normal = {
      repl = {
        ...
        show = nvlime_leader .. "o",
        clear = nvlime_leader .. "-",
        send_atom_expr = nvlime_leader .. "ss",
        send_atom = nvlime_leader .. "sa",
        send_toplevel_expr = nvlime_leader .. "d",
        prompt = nvlime_leader .. "si"
      },
    }
  },
  global = {
